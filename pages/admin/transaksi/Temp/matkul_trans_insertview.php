...
<button onclick="location.href='../master/tidak_aktifkan_mk.php'">Semua Mata Kuliah Tidak Aktif dan Tidak Ditawarkan</button>
<button onclick="location.href='../master/aktifkan_mk_tahun_terbaru.php'">Aktifkan dan Tawarkan Mata Kuliah Untuk Kurikulum Terbaru</button>
</form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
...
echo "</thead>";
echo "<tbody>";
$sql = mysql_query("SELECT MATAKULIAH.KODEMATKUL,.MATAKULIAH.NAMAMATKUL,MATAKULIAH.SKS,
...
ON SEMESTER.KODESEMESTER=MATAKULIAH.KODESEMESTER") or die (mysql_error());
