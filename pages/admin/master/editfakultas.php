...
<?php include("../sidebaradmin.php")?>
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">UBAH DATA FAKULTAS</h1>
                </div>
                <div class="row col-lg-6">
                <?php
$sql = mysqli_query($koneksi,"SELECT KODEFAKULTAS,NAMAFAKULTAS FROM FAKULTAS WHERE KODEFAKULTAS='$_GET[kodefakultas]'") or die (mysql_error());
mysqli_select_db($koneksi,$nama_db) or die("Gagal memilih database!");
$row=mysqli_fetch_array($sql);
?>
<form method="post" action="updatefakultas.php" style="font-size:16px">
<div class="form-group">
<label>Kode Fakultas</label>
<input class="form-control" type="text" name="kodefakultas" value="<?php echo $row['KODEFAKULTAS']; ?>" disabled/><br>
<input type="hidden" name="kodefak" value="<?php echo $row['KODEFAKULTAS']; ?>"/>
</div>

<div class="form-group">
<label>Nama Fakultas</label>
<input class="form-control" type="text" name="namafakultas" value="<?php echo $row['NAMAFAKULTAS']; ?>" required/><br>
</div>
<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Perbarui </button>
<a href="insertview_fakultas.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</button></a></td>
</form>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
