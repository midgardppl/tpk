...
<?php include("../sidebaradmin.php")?>
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header"> UBAH DATA TAHUN AJARAN </h1>
                </div>
                <div class="row col-lg-6">
                <?php
//echo "KODETHNAJARAN : ".$_GET[kodethnajaran];				
$sql = mysqli_query($koneksi,"SELECT KODETHNAJARAN,TAHUNAJARAN FROM TAHUNAJARAN WHERE KODETHNAJARAN='$_GET[kodethnajaran]'") or die (mysqli_error($koneksi));
mysqli_select_db($koneksi, $nama_db) or die("Gagal memilih database!");
$row=mysqli_fetch_array($sql);
?>
<form method="post" action="updatetahunajar.php" style="font-size:16px">
<div class="form-group">
<label>Kode Tahun Ajaran</label>
<input class="form-control" type="text" name="kodethnajaran" value="<?php echo $row['KODETHNAJARAN']; ?>" disabled/><br>
<input type="hidden" name="kodethnajaran" value="<?php echo $row['KODETHNAJARAN']; ?>"/>
</div>

<div class="form-group">
<label>Nama Tahun Ajaran</label>
<input class="form-control" type="text" name="tahunajaran" value="<?php echo $row['TAHUNAJARAN']; ?>" required/><br>
</div>
<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Perbarui </button>
<a href="insertview_tahunajar.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Batal</button></a></td>
</form>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
