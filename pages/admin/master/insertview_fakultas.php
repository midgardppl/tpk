...
<body>
<?php
$baca_fakultas = mysqli_query($koneksi, "SELECT * FROM fakultas ORDER BY kodefakultas DESC limit 1");
$kd_fakultas_row = mysqli_fetch_array($baca_fakultas);
if(count($kd_fakultas_row) == 0) $urut_kd = "00"."1";
else {
	$kd_fakultas = $kd_fakultas_row[0];
	$urut_kd_no = substr($kd_fakultas,3,strlen($kd_fakultas))+1;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="insertfakultas.php" style="font-size:16px">
<div class="form-group">
<label>KODE FAKULTAS</label>

<input class="form-control" type="text" name="kodefakultas" maxlength="20" autofocus required value="fak<?php  echo $urut_kd; ?>" readonly/><br>
</div>
<div class="form-group">
<label>NAMA FAKULTAS</label>
<input class="form-control" type="text" name="namafakultas" placeholder="masukkan nama fakultas" maxlength="25" required/><br>
</div>
...
echo "</thead>";
echo "<tbody>";
$sql = mysqli_query($koneksi, "SELECT KODEFAKULTAS,NAMAFAKULTAS FROM FAKULTAS") or die (mysql_error());
...
?>
    <tr>
        ...
        <td><a href="editfakultas.php?kodefakultas=<?php echo $row['KODEFAKULTAS']; ?>"><button> Ubah</button></a>
            <a href="deletefakultas.php?kodefakultas=<?php echo $row['KODEFAKULTAS']; ?>"><button> Hapus</button></a>
        </td>
    </tr>
<?php
}
