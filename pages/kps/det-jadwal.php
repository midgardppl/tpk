...
echo "<tr>";
   ...
   echo "<th>Ruangan</th>";
   echo "<th>Hari</th>";
    echo "<th style='width:100px'>Jam 1</th>";
    echo "<th style='width:100px'>Jam 2</th>";
...
?>
    <tr>
        ...
        <td><?php echo $r[2]; ?> </td>
        <td><?php echo $h[1];?></td>
        <td><?php echo $j1[1]."-".$j1[2];?></td>
        <td><?php echo $j2[1]."-".$j2[2];?></td>
		<td><?php echo $p[2];?></td>
		<td><?php echo $k[1];?></td>
    </tr>
<?php
...
echo "</table>";
if($dt[4]=="MENUNGGU"){
echo "<input type=button onClick=\"location.href='view_jadwal.php'\" value=\"Kembali\"> <input type=button onClick=\"location.href='accjadwal.php?k=".$_REQUEST['kd']."'\" value=\"Setuju\">";
} else {
echo "<input type=button onClick=\"location.href='view_jadwal.php'\" value=\"Kembali\">";
